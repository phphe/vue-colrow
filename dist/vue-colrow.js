...
(function (global, factory) {
  ...
  _export$1(_export$1.P + _export$1.F * _failsIsRegexp(ENDS_WITH), 'String', {
    endsWith: function endsWith(searchString /* , endPosition = @length */) {
      var that = _stringContext(this, searchString, ENDS_WITH);
      var endPosition = arguments.length > 1 ? arguments[1] : undefined;
      var len = _toLength$1(that.length);
      var end = endPosition === undefined ? len : Math.min(_toLength$1(endPosition), len);
  ...
  for (var collections = _objectKeys$1(DOMIterables$1), i$1 = 0; i$1 < collections.length; i$1++) {
    ...
    var key$1;
    if (proto$2) {
      if (!proto$2[ITERATOR$5]) _hide$1(proto$2, ITERATOR$5, ArrayValues);
      if (!proto$2[TO_STRING_TAG$1]) _hide$1(proto$2, TO_STRING_TAG$1, NAME$1);
      _iterators$1[NAME$1] = ArrayValues;
      if (explicit) for (key$1 in es6_array_iterator$1) if (!proto$2[key$1]) _redefine$1(proto$2, key$1, es6_array_iterator$1[key$1], true);
    }
  }
