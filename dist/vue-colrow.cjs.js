...
var script = {
  ...
  data: function data() {
    ...
    return {
      gutterX: null,
      gutterY: null,
      className: "cr-row-".concat(hp.strRand()),
      innerHeight: null,
      updateInnerHeight: function updateInnerHeight() {
        var inner = _this.$refs.inner;

        if (inner) {
          var h = hp.getBoundingClientRect(inner).height;
      ...
      return _regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              _this3.className = "cr-row-".concat(hp.strRand()); // make root element update when in nuxt
            ...
            case 3:
              if (_this3.heightCalculation) {
                ...
                hp.onDOM(window, 'resize', _this3.updateInnerHeight);
...
var script$1 = {
  ...
  data: function data() {
    return {
      className: "cr-col-".concat(hp.strRand())
    };
  },
  computed: {
    styleText: function styleText() {
  ...
  // created() {},
  mounted: function mounted() {
    this.className = "cr-col-".concat(hp.strRand()); // make root element update when in nuxt
  } // beforeDestroy() {},
...
var script$2 = {
  ...
  data: function data() {
    return {
      className: "cr-break-row-".concat(hp.strRand())
    };
  },
  computed: {
    styleText: function styleText() {
  ...
  mounted: function mounted() {
    this.className = "cr-break-row-".concat(hp.strRand()); // make root element update when in nuxt
  }
};
